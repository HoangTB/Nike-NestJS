...
const Favorites: React.FC = () => {
  ...
  return (
    <div className="m-4 text-center form-favorite-top">
      <ToastContainer />
          ...
          dataFavorite.map((item: IFavorite, index) => {
            return (
              <div className="pb-5" key={index}>
                <div className="d-flex justify-content-center gap-5 form-favorite-child">
                  ...
                  <div className="col-md-8 d-flex align-items-center">
                    <div className="row justify-content-between w-100 form-content-favorite">
